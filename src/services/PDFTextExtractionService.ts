...
class PDFTextExtractionService {
  private static instance: PDFTextExtractionService;
  
  private constructor() {}
  
  public static getInstance(): PDFTextExtractionService {
   ...
   */
  public async extractText(filePath: string): Promise<ExtractionResult> {
   ...
   */
  private async extractTextDirect(filePath: string): Promise<ExtractionResult> {
   ...
   */
  private async extractTextOCR(filePath: string): Promise<ExtractionResult> {
   ...
   */
  private generateSampleMedicalText(): string {
    const texts = [
      `PATIENT REFERRAL
Date: May 5, 2025
