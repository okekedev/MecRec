...
type DocumentChatRouteParams = {
  documentId: string;
};

type DocumentChatScreenRouteProp = RouteProp<
  { DocumentChat: DocumentChatRouteParams },
  'DocumentChat'
>;

const DocumentChatScreen = () => {
  const route = useRoute<DocumentChatScreenRouteProp>();
